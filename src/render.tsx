      ...
      <html>
        ...
        <body class="bg-gray-100 flex items-center justify-center h-screen p-4">
          <div class="w-full max-w-sm">
            <form id="login-form" class="bg-white shadow-md rounded px-6 pt-6 pb-8 mb-4">
              <div class="mb-4">
  ...
  return (
    <html>
      ...
      <body class="bg-gray-100 font-sans antialiased">
        {showWarning && (
          <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-3 mb-4 text-sm sm:text-base" role="alert">
        ...
        <div class="flex flex-col md:flex-row min-h-screen">
          <button
            id="hamburger-btn"
            class="md:hidden p-3 bg-gray-800 text-white focus:outline-none fixed top-0 left-0 w-12 sm:w-16 z-30"
          >
            ☰
          </button>
          ...
          <div
            id="sidebar"
            class="w-56 sm:w-64 bg-gray-800 text-white p-4 fixed md:relative left-0 top-0 h-full z-20 transition-transform duration-300 ease-in-out sidebar-hidden md:translate-x-0"
          >
            <h1 class="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center">管理面板</h1>
            <nav>
              <a href="#" class="block py-2 px-4 rounded hover:bg-gray-700 text-sm sm:text-base">
                密钥管理
              </a>
            </nav>
          </div>
          ...
          <div class="flex-1 p-4 sm:p-6 md:p-8 overflow-y-auto mt-14 sm:mt-16 md:mt-0">
            <h2 class="text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6">Gemini API 密钥管理</h2>
            <div class="grid grid-cols-1 gap-4 sm:gap-6 md:gap-8">
              <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
                <h3 class="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">批量添加密钥</h3>
                <form id="add-keys-form">
                  <textarea
                    id="api-keys"
                    class="w-full h-32 sm:h-40 p-2 border rounded bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
                    placeholder="请输入API密钥，每行一个"
                  ></textarea>
                  <button
                    type="submit"
                    class="mt-3 sm:mt-4 w-full px-3 sm:px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition duration-200 text-sm sm:text-base"
                  >
                    添加密钥
                  </button>
                </form>
              ...
              <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 sm:mb-4">
                  <h3 class="text-lg sm:text-xl font-semibold mb-2 sm:mb-0">已存储的密钥</h3>
                  <div class="flex flex-wrap gap-2">
                    <button
                      id="check-keys-btn"
                      class="px-3 sm:px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition duration-200 text-sm sm:text-base"
                    >
                      一键检查
                    </button>
                    <button
                      id="refresh-keys-btn"
                      class="px-3 sm:px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 transition duration-200 text-sm sm:text-base"
                    >
                      刷新
                    </button>
                  </div>
                </div>
                <div class="max-h-60 overflow-y-auto overflow-x-auto border rounded">
                  <table id="keys-table" class="w-full min-w-[400px] text-left text-sm sm:text-base">
                    <thead>
                      <tr class="border-b">
                        <th class="p-2 w-6">
                ...
                <button
                  ...
                  class="mt-3 sm:mt-4 w-full px-3 sm:px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition duration-200 hidden text-sm sm:text-base"
                >
                  删除选中
                </button>
              </div>
                  ...
                  try {
                    ...
                    if (!keys || keys.length === 0) {
                      ...
                      keys.forEach(key => {
                        ...
                        keyCell.className = 'p-2 font-mono break-all';
						...
						<div class="grid grid-cols-1 gap-4 sm:gap-6 md:gap-8">
							<div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
								...
								<form id="add-keys-form">
									<textarea
										...
										placeholder="请输入API密钥，每行一个"
									></textarea>
									<button type="submit" class="mt-3 sm:mt-4 w-full px-3 sm:px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition duration-200 text-sm sm:text-base">
										添加密钥
									</button>
								</form>
							</div>
							<div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
								<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 sm:mb-4">
									<h3 class="text-lg sm:text-xl font-semibold mb-2 sm:mb-0">已存储的密钥</h3>
									<div class="flex flex-wrap gap-2">
										<button id="check-keys-btn" class="px-3 sm:px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition duration-200 text-sm sm:text-base">
											一键检查
										</button>
										<button id="refresh-keys-btn" class="px-3 sm:px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 transition duration-200 text-sm sm:text-base">
											刷新
										</button>
									</div>
								</div>
